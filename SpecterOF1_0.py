...
class SimpleSwitch15(app_manager.RyuApp):
    ...
    def confidence_award(self, ev):
        ...
        #         #reject this request
        #         self.blacklist_user(src_ip, msg)
        #         # break function
        #         return
        #     else:
    ...
    def blacklist_user(self, src_ip, msg):
        global confidence_list
        ...
        if src_ip is src_ip:
            ...
            in_port = msg.in_port
            match = parser.OFPMatch(            #Or this, see below
                in_port=in_port,
            ...
            mod = parser.OFPFlowMod(
                datapath=datapath,
                match=match,
                command=ofproto.OFPFC_ADD,      #This may cause trouble
                priority=priority,
                instructions=inst)
            datapath.send_msg(mod)
